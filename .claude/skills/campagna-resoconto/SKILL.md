...
- Se un resoconto precedente ha già «inquinato» Aspetto o Riferimento visivo con uno stato di scena, segnalarlo come **debito di scheda** e proporre ripristino ai tratti fissi (regola `.claude/rules/personaggio-aspetto.md`, sezione «Tratti fissi vs stato di scena»).
