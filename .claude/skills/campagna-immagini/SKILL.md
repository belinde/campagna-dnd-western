...
3. Per `personaggi/` e `png/`, privilegia `## Aspetto`, `## Riferimento visivo`, `## Eventi interessanti`, il **Promemoria** in testa alla scheda e l'eventuale `## Immagine`. Dopo l'import, verifica coerenza tra ritratto, Aspetto e Riferimento visivo (regola `.claude/rules/personaggio-aspetto.md`).
4. Per `ambientazione/luoghi/`, privilegia `## Aspetto`, `## Riferimento visivo`, `## Punti di interesse` e l'eventuale `## Immagine`. Dopo l'import, verifica coerenza tra veduta, Aspetto e Riferimento visivo (regola `.claude/rules/personaggio-aspetto.md`).
