...
Descrizione fisica in 2-4 frasi — **solo tratti fissi** (identita` visiva permanente), anche se provvisorio. Stati emotivi o fisici dell'incontro in corso vanno in Note DM o in un appunto separato, non qui. Consolidamento e regola completa: `.claude/rules/personaggio-aspetto.md` («Tratti fissi vs stato di scena»).
