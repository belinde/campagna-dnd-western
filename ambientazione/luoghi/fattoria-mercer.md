...
**Regione:** Middle West (entroterra orientale di Valdoren)
...
- **Henry caduto sulla soglia.** Il cadavere del padre dietro la casa racconta qualcosa: è disarmato? Ha il fucile in mano? È stato colpito di fronte o alle spalle? Da quanto si capisce, è probabile che sia uscito incontro ai briganti per dare a Martha il tempo di nascondere Dorothy nella botola — un piccolo gesto di coraggio che la bambina, forse, ha sentito ma non visto.
- **Il pozzo come testimone.** I carovaniere abituali della Via dei Coloni si fermavano qui regolarmente. Qualcuno di loro deve aver visto qualcosa nei giorni precedenti l'attacco — un cavallo nuovo legato al recinto, una faccia che non era di Henry, un movimento sospetto nei boschetti.
- **Il contratto sulla terra.** La concessione su questo lotto, ora che i proprietari sono morti, torna sul mercato. Qualcuno potrebbe avere fretta di farsela assegnare, e quella fretta potrebbe rivelarsi più interessante del movente apparente dell'attacco.
- **L'eredità di Dorothy.** Tecnicamente la bambina ha diritto alla terra, agli animali superstiti, ai pochi dollari nascosti chissà dove (sotto un'asse del pavimento? in una latta in cantina?). Tradurre quel diritto in qualcosa di reale, in un mondo dove una bambina di sette anni non ha né tutore né avvocato, è un piccolo problema giuridico e umano che la carovana si porterà dietro.
- **Le scorte invernali.** A fine autunno, il maiale doveva essere macellato, le mele seccate, le verdure messe sotto sale: tutto il lavoro che Martha aveva preparato per arrivare alla primavera. Quel lavoro, non finito, è ancora lì — e qualcuno, prima o poi, dovrà decidere cosa farne.
- **Il filo da Selvarno.** I Mercer erano partiti dalla città dell'università e dell'abolizionismo: qualcuno a Selvarno potrebbe ancora ricordarsi di loro — un parente, un vecchio datore di lavoro, una congregazione, una maestra di scuola che aveva insegnato a leggere a Martha. Per Dorothy, è l'unico mondo che si possa chiamare "casa di prima" oltre la fattoria.
- **La bambina che sa leggere.** Dorothy sa leggere e scrivere — un dettaglio raro per una contadina della sua età, retaggio dell'ora di lezione che Henry e Martha le imponevano ogni sera. È un dettaglio che potrebbe rivelarsi decisivo nei rapporti con i PG colti del gruppo, e che racconta dei genitori più di quanto non dica della figlia.
