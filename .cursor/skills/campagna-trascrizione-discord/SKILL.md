...
Per **principio «non inventare»**, dimensione chunk, overlap analitico, **Fase A**, **Fase B**, **Fase C** (C1 salvo aggiunte sotto, C3–C6), template strutturale e vincoli finali: applicare integralmente [`.cursor/skills/campagna-trascrizione-vc/SKILL.md`](../campagna-trascrizione-vc/SKILL.md) **salvo** gli override espliciti in questa skill.
